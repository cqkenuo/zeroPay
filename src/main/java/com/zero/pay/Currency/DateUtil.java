...
/**
 * Create  by wgh on 2019/12/2 22:22.
 */
public class DateUtil {
     ...
     */
    public static Long GetsecondTosecond(String va1, String va2, Integer var3) throws ParseException {
//        System.out.println(va1 + " \t与\t " + va2 + "\t时间对比");
        SimpleDateFormat format = new SimpleDateFormat(parsePatterns[1]);
        Date parse = format.parse(va1);
        Date date = format.parse(va2);
...
//        System.out.println(day + "天" + hour + "小时" + min + "分" + s + "秒");
    ...
    public static Date parseDate(Object str) {
        ...
        return DateUtil.parseDate(str.toString());
    }
